...
class DocumentTestCase(TestCase):
    ...
    def test_queryset_pagination_added(self):
        ...
        self.assertEqual(CarDocument.django.queryset_pagination, DEDConfig.default_queryset_pagination())
    ...
    def test_init_prepare_correct(self):
        ...
        expect = {
            'color': ("<class 'django_opensearch_dsl.fields.TextField'>",
                      ("<class 'method'>", "<type 'instancemethod'>")),  # py3, py2
            'type': ("<class 'django_opensearch_dsl.fields.TextField'>",
                     ("<class 'functools.partial'>", "<type 'functools.partial'>")),
            'name': ("<class 'django_opensearch_dsl.fields.TextField'>",
                     ("<class 'functools.partial'>", "<type 'functools.partial'>")),
            'price': ("<class 'django_opensearch_dsl.fields.DoubleField'>",
                      ("<class 'functools.partial'>", "<type 'functools.partial'>")),
        }
