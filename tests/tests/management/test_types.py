...
class TypeTestCase(TestCase):
    ...
    def test_datetime_parser(self):
        ...
        self.assertEqual(
            datetime.datetime(2020, 8, 17, 0, 0, tzinfo=datetime.timezone.utc), types.datetime_parser("2020-W34")
        )
        self.assertEqual(
    ...
    def test_parsers(self):
        ...
        self.assertEqual(datetime.datetime(2020, 8, 20, 0, 0, tzinfo=datetime.timezone.utc), types.parse("2020-08-20"))
